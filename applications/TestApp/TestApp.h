...
class TestAppAPP : public Application {
 public:
...
#else
  CreateSavedVar("TestApp", number, uint8_t, 0);
  CreateSavedVar("TestApp", color, Color, Color(0xFFFFFF));
...
inline Application_Info TestAppAPP::info = {
    .name = "TestApp",
...
REGISTER_APPLICATION(TestAppAPP);
